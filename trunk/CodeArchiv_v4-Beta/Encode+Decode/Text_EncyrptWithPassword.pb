; German forum: http://www.purebasic.fr/german/archive/viewtopic.php?t=3399&highlight=
...
Procedure.s Encrypt(Password.s, Input.s) 
  Define.l PasswordVal, CurrentChar, CurrentMod 
  enctxt.s  
...
Procedure Open_Window_0() 
  If OpenWindow(#Window_0, 433, 212, 322, 376, "Text-Crypt",  #PB_Window_SystemMenu | #PB_Window_TitleBar | #PB_Window_ScreenCentered ) 
    ...
    If CreateGadgetList(WindowID(#Window_0)) 
      ...
      StringGadget(#String_1, 20, 70, 280, 100, "", #ES_MULTILINE|#ES_AUTOVSCROLL|#WS_VSCROLL|#ESB_DISABLE_LEFT|#ESB_DISABLE_RIGHT) 
      ...
      StringGadget(#String_2, 20, 250, 280, 100, "", #ES_MULTILINE|#ES_AUTOVSCROLL|#WS_VSCROLL|#ESB_DISABLE_LEFT|#ESB_DISABLE_RIGHT) 
