...
Repeat 
  ...
  If MouseButton1 And oldMouseButton1 = 0 
    If MouseX>=200 And MouseX<=300 And MouseY>=200 And MouseY<=300 
      ...
      TextColor = 254 : Msg = 1 
    EndIf 
  ElseIf MouseButton1 = 0 And oldMouseButton1 
    If Box 
      Box ! 1 
      If MouseX>=200 And MouseX<=300 And MouseY>=200 And MouseY<=300 
        TextColor = 254 : Msg = 2 
  ...
  If TextColor 
    StartDrawing(ScreenOutput()) 
      DrawingMode(1) 
      FrontColor(RGB(TextColor,TextColor,TextColor)) 
      Select Msg 
        Case 1 
          DrawText(100,100,"Button 1 LeftClick - PRESSED") 
        Case 2 
          DrawText(100,100,"Button 1 LeftClick - RELEASED") 
      EndSelect 
    StopDrawing() 
    TextColor - 2 
  EndIf 
