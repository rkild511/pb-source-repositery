...
; Especially for Win98 compatibility, there isn't the mirror effect possible...
; Speziell für Win98 Kompatibilität, dort ist allerdings der Spiegeleffekt nicht möglich...
...
Procedure ImageReCreate(w,h) 
  ...
  dc=StartDrawing(ImageOutput(0)) 
    ...
    ReDrawText(TextObject2,0,h/2,w,h,dc) 
  StopDrawing() 
EndProcedure 
