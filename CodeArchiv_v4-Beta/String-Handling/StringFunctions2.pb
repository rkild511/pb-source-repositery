...
; Ich hab mich gestern und heute mal an ein paar Stringfunktionen versucht. Das heißt, ich hab schon
; fast alle Stringfunktionen von PB nachprogrammiert. Der Unterschied ist allerdings, dass die Länge
; der Strings nicht begrenzt ist und man sie auch in Threads verwenden kann. 
; Ein paar Einschränkungen gibt es aber leider immer noch. Hier schonmal die Funktionen mit einfachen
; Beispielen und kleinen Hilfetexten
...
Procedure.l mNewString(String.s) 
  ...
  hString = GlobalAlloc_(#GPTR, sString) 
...
Procedure.l mReserveString(Length.l) 
  Protected hString.l 
  hString = GlobalAlloc_(#GPTR, Length + 1) 
  ProcedureReturn hString 
EndProcedure 
...
Procedure.l mChangeString(hString.l, String.s) 
  Protected sString.l 
  sString = Len(String) + 1 
  shString = GlobalSize_(hString) 
  If sString < shString 
    hString = GlobalReAlloc_(hString, sString, 0) 
...
Procedure.l mCopyString(hString1.l, hString2.l) 
  ...
  sString1 = GlobalSize_(hString1) 
  sString2 = GlobalSize_(hString2) 
  If sString1 < sString2 
    hString2 = GlobalReAlloc_(hString2, sString1, 0) 
  ElseIf sString1 > sString2 
    GlobalFree_(hString2) 
    hString2 = GlobalAlloc_(#GPTR, sString1) 
  EndIf 
...
Procedure.l mFreeStr(hString.l) 
  ProcedureReturn GlobalFree_(hString) 
EndProcedure 
...
Procedure.l mAddString(hString1.l, hString2.l) 
  ...
  sString1 = GlobalSize_(hString1) 
  sString2 = GlobalSize_(hString2) 
  hString = GlobalAlloc_(#GPTR, sString1 + sString2 - 1) 
...
Procedure.l mLeft(hString1.l, Length.l) 
  ...
  If sString1 - 1 < Length 
    Length = sString1 - 1 
  EndIf 
  hString2 = GlobalAlloc_(#GPTR, Length + 1) 
...
Procedure.l mMidEnd(hString1.l, Position.l) 
  Protected sString1.l, hString2.l 
  sString1.l = GlobalSize_(hString1) 
  If sString1 - 1 < Position 
    hString2 = GlobalAlloc_(#GPTR, 1) 
    ProcedureReturn hString2 
  EndIf 
  hString2 = GlobalAlloc_(#GPTR, sString1 - Position + 1) 
...
Procedure.l mSpace(Length.l) 
  ...
  hString = GlobalAlloc_(#GPTR, Length + 1) 
  For *z = hString To hString + Length - 1 
    *z\b = 32 
  Next 
  ProcedureReturn hString 
EndProcedure 
  ...
  *z = hString1 
  ...
  While _Continue 
    ...
    *z + 1 
    ...
    EndIf 
  Wend 
  hString2 = GlobalAlloc_(#GPTR, *z - Begin - 1) 
...
Procedure.l mTrim(hString1.l) 
  ...
  *z = hString1 + sString1 - 2 
  ...
  If Begin = Ends 
    ...
    EndIf 
  EndIf 
  hString2 = GlobalAlloc_(#GPTR, sString1 - (Begin + Ends)) 
  GlobalFree_(hString1) 
...
;RETURN : #False = Position außerhalb des Bereichs, #True = OK 
