; German forum: 
; Author: Daniel (updated for PB4.00 by blbltheworm)
; Date: 31. December 2002
; OS: Windows
; Demo: No


; Calculator for quadratic functions
...
PanelGadget(0,0,0,160,180)
  ...
  AddGadgetItem(0,4,"Eigenschaften f(x)")
   ...
   EditorGadget(30,8,38,141,113)
  CloseGadgetList()          ; ClosePanelGadget() was used until PB3.62
EndIf


;RichEditFont(0,"Times New Roman (Western)",$00000000,$00FFFFFF,10,0,0,0,0)
...
panel5:
  ...
  temp3=temp3+"Wertebereich:"+Chr(10)+"yeR ; y >= "+StrF(c4)+Chr(10)
  temp3=temp3+"monoton F/S:"+Chr(10)+"x >= "+StrF(b4)+" ; x <= "+StrF(b4)+Chr(10)
  ...
  If temp1=temp2
   temp2="---"
  EndIf
  temp3=temp3+"Schnittpunkt x-Achse:"+Chr(10)+"x1 = "+temp1+Chr(10)
  temp3=temp3+"x2 = "+temp2+Chr(10)
  temp3=temp3+"Schnittpunkt y-Achse:"+Chr(10)+"y = "+GetGadgetText(27)
  SetGadgetText(30,temp3)
Return
