...
; Reworked for use with PureBasic 4.0 by ste123
; This version doesn't need Francos OnEvent userlib anymore!
; 
; USAGE: 
; 
...
Enumeration
	#Outlook
	#OutlookButton1 : #OutlookButton2 : #OutlookButton3 : #OutlookButton4
	#SA1Button1 : #SA1Button2 : #SA1Button3 : #SA1Button4
	#SA2Button1 : #SA2Button2 : #SA2Button3 : #SA2Button4
	#SA3Button1 : #SA3Button2 : #SA3Button3 : #SA3Button4
	#SA4Button1 : #SA4Button2 : #SA4Button3 : #SA4Button4
EndEnumeration
...
If OutlookGadget( #Outlook , 50 , 10 , 10 , 250 , 4 ) 
  ...
  If ScrollArea1 
    AddOutlookGadgetItem( #SA1Button1 , 1 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea1) 
    AddOutlookGadgetItem( #SA1Button2 , 2 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea1) 
    AddOutlookGadgetItem( #SA1Button3 , 3 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea1) 
    AddOutlookGadgetItem( #SA1Button4 , 4 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea1) 
    CloseGadgetList()
  EndIf

  ScrollArea2 = AddOutlookGadgetGroup( #OutlookButton2 , 2 , "Button 2" )
  If ScrollArea2 
    AddOutlookGadgetItem( #SA2Button1 , 1 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea2) 
    AddOutlookGadgetItem( #SA2Button2 , 2 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea2) 
    AddOutlookGadgetItem( #SA2Button3 , 3 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea2) 
    AddOutlookGadgetItem( #SA2Button4 , 4 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea2) 
    CloseGadgetList()
  EndIf

  ScrollArea3 = AddOutlookGadgetGroup( #OutlookButton3 , 3 , "Button 3" )
  If ScrollArea3 
    AddOutlookGadgetItem( #SA3Button1 , 1 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea3) 
    AddOutlookGadgetItem( #SA3Button2 , 2 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea3) 
    AddOutlookGadgetItem( #SA3Button3 , 3 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea3) 
    AddOutlookGadgetItem( #SA3Button4 , 4 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea3) 
    CloseGadgetList()
  EndIf

  ScrollArea4 = AddOutlookGadgetGroup( #OutlookButton4 , 4 , "Button 4" )
  If ScrollArea4 
    AddOutlookGadgetItem( #SA4Button1 , 1 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea4) 
    AddOutlookGadgetItem( #SA4Button2 , 2 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea4) 
    AddOutlookGadgetItem( #SA4Button3 , 3 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea4) 
    AddOutlookGadgetItem( #SA4Button4 , 4 , "../Graphics/Gfx/GeeBee2.bmp" , ScrollArea4) 
    CloseGadgetList()
  EndIf
  CloseGadgetList()
...
Repeat 
  ...
  Select Event 
    ...
    Case #PB_Event_Gadget 
      ...
      If			gadgetid=#OutlookButton1
      	ActivateOutlookGadgetGroup(1)
      ElseIf	gadgetid=#OutlookButton2
      	ActivateOutlookGadgetGroup(2)
      ElseIf	gadgetid=#OutlookButton3
      	ActivateOutlookGadgetGroup(3)
      ElseIf	gadgetid=#OutlookButton4
