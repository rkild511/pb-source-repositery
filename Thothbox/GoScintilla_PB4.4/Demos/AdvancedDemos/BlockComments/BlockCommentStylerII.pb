...
;*  Platforms:  All.
;*    
;*  Block comment II demo (C syntax).
;*  This demo extends the original block comment demo by also styling single line comments, those beginning with //.
;/////////////////////////////////////////////////////////////////////////////////
...
If OpenWindow(0, 100, 200, 600, 600, "GoScintilla demo!", #PB_Window_SystemMenu | #PB_Window_MinimizeGadget | #PB_Window_MaximizeGadget | #PB_Window_ScreenCentered | #PB_Window_SizeGadget)
  ...
  ;=========================================
    ...
    ;Now set up quotes to denote literal strings. Note the space separating the pair of quotes from the pair of ' symbols.
...
; IDE Options = PureBasic 4.50 Beta 1 (Windows - x86)
